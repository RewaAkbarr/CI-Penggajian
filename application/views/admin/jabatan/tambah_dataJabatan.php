...
<div class="card" style="width: 60% ; margin-bottom: 100px">
	<div class="card-body">
		<form method="POST" action="<?php echo base_url('admin/data_jabatan/tambah_data_aksi')?>">
			...
			<div class="form-group">
				<label>Bonus</label>
				<input type="number" name="bonus_pegawai" class="form-control">
				<?php echo form_error('bonus_pegawai', '<div class="text-small text-danger"> </div>')?>
			</div>

			<div class="form-group">
				<label>PPH</label>
				<input type="number" name="pph_pegawai" class="form-control">
				<?php echo form_error('pph_pegawai', '<div class="text-small text-danger"> </div>')?>
			</div>
