	...
	<table class="table table-bordered table-triped">
			...
			<tr>
				...
				<td class="text-center">Rp. <?php echo number_format($g->gaji_pokok,0,',','.') ?></td>
						...
						<td class="text-center">Rp. <?php echo number_format($g->bonus_pegawai,0,',','.') ?></td>
						<td class="text-center">Rp. <?php echo number_format(($g->gaji_pokok + $g->tj_transport + $g->bonus_pegawai) * 5/100,0,',','.') ?></td>
						<td class="text-center">Rp. <?php echo number_format($potongan,0,',','.') ?></td>
						<td class="text-center">Rp. <?php echo number_format($g->gaji_pokok + $g->tj_transport + $g->bonus_pegawai - (($g->gaji_pokok + $g->tj_transport + $g->bonus_pegawai) * 5/100) - $potongan,0,',','.') ?></td>
			</tr>
			<?php endforeach ;?>
		</table>
