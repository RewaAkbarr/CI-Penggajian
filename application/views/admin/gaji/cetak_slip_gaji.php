...
<body>
	...
	<table class="table table-striped table-bordered mt-3">
		...
		<tr>
			<td>3</td>
			<td>Bonus</td>
			<td>Rp. <?php echo number_format($ps->bonus_pegawai,0,',','.') ?></td>
		</tr>

		<tr>
			<td>3</td>
			<td>PPH</td>
			<td>Rp. <?php echo number_format(($ps->gaji_pokok + $ps->bonus_pegawai + $ps->tj_transport) * 5/100,0,',','.') ?></td>
		</tr>
		...
		<tr>
			...
			<th>Rp. <?php echo number_format($ps->gaji_pokok + $ps->tj_transport + $ps->bonus_pegawai - (($ps->gaji_pokok + $ps->tj_transport + $ps->bonus_pegawai) * 5/100) - $potongan_gaji,0,',','.') ?></th>
		</tr>
	</table>
